...
def load_custom_pretrained(model, default_cfg=None, load_fn=None, progress=False, check_hash=False):
    ...
    # cached_file = '/disks/disk0/feifei/paper/paper3/S_16-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_224.npz' ## vit_small_patch16_224
    cached_file = '/disks/disk0/feifei/paper/paper3/B_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.01-res_224.npz'  ## vit_base_patch16_224
