...
from models.ViT import VT, vit_model
...
def main():
    ...
    ## vit_small_patch16_224, vit_base_patch16_224，only comment out
    # backbone = vit_model['vit_small_patch16_224'](pretrained=True, args=args, VisionTransformerModule=VT)
    backbone = vit_model['vit_base_patch16_224'](pretrained=True, args=args, VisionTransformerModule=VT)
